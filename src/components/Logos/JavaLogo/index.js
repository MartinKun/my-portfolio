      ...
      <LogoContainer>
        ...
        >
          ...
          <path
            ...
            className={
              isMouseEnter
                ? styles.pathTwoMouseOver
                : isLightOn
                ? styles.pathTwoLightMode
                : styles.pathTwoDarkMode
            }
          />
          <path
            ...
            className={
              isMouseEnter
                ? styles.pathThreeMouseOver
                : isLightOn
                ? styles.pathThreeLightMode
                : styles.pathThreeDarkMode
            }
          />
          <path
            ...
            className={
              isMouseEnter
                ? styles.pathFourMouseOver
                : isLightOn
                ? styles.pathFourLightMode
                : styles.pathFourDarkMode
            }
          />
          <path
            ...
            className={
              isMouseEnter
                ? styles.pathFiveMouseOver
                : isLightOn
                ? styles.pathFiveLightMode
                : styles.pathFiveDarkMode
            }
          />
          <path
            ...
            className={
              isMouseEnter
                ? styles.pathSixMouseOver
                : isLightOn
                ? styles.pathSixLightMode
                : styles.pathSixDarkMode
            }
          />
          <path
            ...
            className={
              isMouseEnter
                ? styles.pathSevenMouseOver
                : isLightOn
                ? styles.pathSevenLightMode
                : styles.pathSevenDarkMode
            }
          />
        </svg>
        <Overlay id={"java"} title={"Java"}/>
      </LogoContainer>
    </>
  );
};
