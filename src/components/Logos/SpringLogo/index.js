  ...
  return (
    <LogoContainer>
      ...
      >
        <style></style>
        <path
          className={isMouseEnter ? styles.springLogoMouseEnter : (isLightOn ? styles.springLogoLightMode : styles.springLogoDarkMode)}
          class="st0"
          fill="#ffffff"
      ...
      <Overlay id={"spring"} title={"Spring"} />
